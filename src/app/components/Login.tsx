      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          <div className="inline-block mb-6">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#0A84FF] to-[#FF8A3D] flex items-center justify-center">
              <span className="text-3xl font-bold">D</span>
            </div>
          </div>
          <h1 className="text-3xl font-bold mb-2">Desenrola Já</h1>
          <p className="text-gray-400">Your problem solved in minutes.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button className="text-[#0A84FF] text-sm text-right w-full hover:underline">
            Forgot password?
          </button>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="bg-white/5 border border-white/10 rounded-2xl py-4 flex items-center justify-center gap-2 hover:bg-white/10 transition-all"
            >
